                        ...
                        switch (res.status) {
                            case 200:
                                ...
                                if (resData.length !== 0) {
                                    ...
                                    _t.formItem.title = resData[0].travelTitle; // 标题
                                    if (resData[0].travelTime !== undefined && resData[0].travelTime !== null && resData[0].travelTime !== '0') {
                                        _t.formItem.time = new Date(Number(resData[0].travelTime)); // 行程时间
                                    }
                                    _t.formItem.address = resData[0].travelAddress; // 地点
